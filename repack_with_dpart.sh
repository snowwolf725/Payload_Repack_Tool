...
./bin/delta_generator_$arch -out_file=output/unsigned-payload.bin -partition_names=$name_list -new_partitions=$file_list -dynamic_partition_info_file=./dyn_part_info.txt 
